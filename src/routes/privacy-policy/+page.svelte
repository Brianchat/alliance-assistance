...
<div>
	...
	<p><b>Last updated April 02, 2023</b></p>
	<p>
		This privacy notice for eNQue Limited (<b>`Company`</b>, <b>`we`</b>, <b>`us`</b>, or <b>`our`</b> ), describes
	...
	<ul>
		<li>
			Visit our website at <a href="http://www.enque.co.uk">http://www.enque.co.uk</a> , or any website
			of ours that links to this privacy notice
		</li>
	</ul>
	<ul>
		<li>
			Download and use our mobile application (Monthlies Simplified) , or any other application of
	...
	<p>
		<b>This summary provides key points from our privacy notice, but you can find out more details
			about any of these topics by clicking the link following each key point or by using our&nbsp;</b><a
			href="/privacy-policy/#toc"><b>table of contents</b></a><b>&nbsp;below to find the section you are looking
			for.</b>
	</p>
	<p>
		<b>What personal information do we process?</b> When you visit, use, or navigate our
		Services, we may process personal information depending on how you interact with eNQue Limited
		and the Services, the choices you make, and the products and features you use. Learn more
		about&nbsp; <a href="/privacy-policy/#personalinfo">personal information you disclose to us</a>.
	</p>
	<p>
	...
	<p>
		<b>Do we receive any information from third parties?</b> We do not receive any information
		from third parties.
	</p>
	<p>
		...
		about&nbsp;<a href="/privacy-policy/#infouse">how we process your information</a>.
	</p>
	<p>
		...
		about&nbsp;<a href="/privacy-policy/#whoshare">when and with whom we share your personal information</a>.
	</p>
	<p>
		<b>How do we keep your information safe?</b> We have organisational and technical
		...
		modify your information. Learn more about&nbsp;<a href="/privacy-policy/#infosafe">how we keep your information
			safe</a>.
	</p>
	<p>
		...
		Learn more about&nbsp;<a href="/privacy-policy/#privacyrights">your privacy rights</a>.
	</p>
	<p>
		<b>How do you exercise your rights?</b> The easiest way to exercise your rights is by
		visiting <a href="http://www.enque.co.uk/data-request">http://www.enque.co.uk/data-request</a> ,
		or by contacting us. We will consider and act upon any request in accordance with applicable data
		protection laws.
	</p>
	<p>
		Want to learn more about what eNQue Limited does with any information we collect?&nbsp; <a
			href="/privacy-policy/#toc">Review the privacy notice in full</a>.
	</p>
	...
	<p>
		<a href="/privacy-policy/#legalbases">3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR PERSONAL
			INFORMATION?</a>
	</p>
	<p>
		<a href="/privacy-policy/#whoshare">4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</a>
	</p>
	...
	<p>
		<a href="/privacy-policy/#caresidents">10. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</a>
	</p>
	<p>
		<a href="/privacy-policy/#virginia">11. DO VIRGINIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</a>
	</p>
	...
	<p>
		<a href="/privacy-policy/#request">14. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</a>
	</p>
	<h2 id="infocollect">1. WHAT INFORMATION DO WE COLLECT?</h2>
	<p><b>Personal information you disclose to us</b></p>
	<p>
		<b>In Short:</b><b>&nbsp;</b>We collect personal information that you
		provide to us.
	</p>
	<p>
	...
	<p>
		...
		with us using your existing social media account details, like your Facebook, Twitter, or other
		social media account. If you choose to register in this way, we will collect the information
		described in the section called <a href="/privacy-policy/#sociallogins">`HOW DO WE HANDLE YOUR SOCIAL
			LOGINS?`</a> below.
	</p>
	<p>
	...
	<ul>
		<li>
			<b>To facilitate account creation and authentication and otherwise manage user accounts.&nbsp;</b>We may
			process your information so you can create and log in to your account, as well as keep
	...
	<p>
		...
		fulfil our contractual obligations, to protect your rights, or to fulfil our legitimate business
		interests.
	</p>
	...
	<ul>
		<li>
			...
			(i.e. consent) to use your personal information for a specific purpose. You can withdraw your
			consent at any time. Learn more about&nbsp;<a href="/privacy-policy/#withdrawconsent">withdrawing your
				consent</a>.
		</li>
	</ul>
	<ul>
		<li>
			<b>Legal Obligations.</b> We may process your information where we believe it is necessary
	...
	<p>
		...
		can be inferred (i.e. implied consent). You can&nbsp;<a href="/privacy-policy/#withdrawconsent">withdraw your
			consent</a>&nbsp;at any time.
	</p>
	<p>
	...
	<p>
		...
		in the section ` <a href="/privacy-policy/#contact">HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a> ` below.
	</p>
	<p>
	...
	<p>
		...
		information, you also have the right to complain to your <a
			href="https://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm">Member State data
			protection authority</a>
		or&nbsp;<a href="https://ico.org.uk/make-a-complaint/data-protection-complaints/data-protection-complaints/">UK
			data protection authority</a>.
	</p>
	<p>
		If you are located in Switzerland, you may contact the <a
	...
	<p id="withdrawconsent">
		...
		<a href="/privacy-policy/#contact">HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a> ` below .
	</p>
	<p>
	...
	<p>
		You may contact us by email at&nbsp; ccpa@enque.org , or by referring to the contact details at
		the bottom of this document.
	</p>
	<p>
		If you are using an authorised agent to exercise your right to opt out we may deny a request if
	...
	<p>
		...
		processes the information on our behalf, following the same strict privacy protection
	...
	<p>
		eNQue Limited &nbsp;has not disclosed, sold, or shared any personal information to third parties
		for a business or commercial purpose in the preceding twelve (12) months. eNQue Limited
	...
	<p>
		To exercise these rights, you can contact us&nbsp; by email at ccpa@enque.org , or by referring
	...
	<p><b>Virginia CDPA Privacy Notice</b></p>
	...
	<p>
		...
		with eNQue Limited and our Services. To find out more, please visit the following links:
	</p>
	<ul>
		<li>
	...
	<p>
		eNQue Limited has not sold any personal data to third parties for business or commercial
		purposes. eNQue Limited will not sell personal data in the future belonging to website visitors,
		users, and other consumers.
	</p>
	...
	<p>
		You may contact us by email at dpo@enque.org , by visiting <a
			href="http://www.enque.co.uk/data-request">http://www.enque.co.uk/data-request</a> , or by referring to the
	...
	<p>
		...
		reasoning behind it.&nbsp;If you wish to appeal our decision, please email us at dpo@enque.org .
		Within sixty (60) days of receipt of an appeal, we will inform you in writing of any action
	...
	<p>
		...
		information, please contact us as per the previous section.
	</p>
</div>
