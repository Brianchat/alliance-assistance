<script>
    ...
    $: signedIn = $user.name ? 'signedIn' : 'signedOut';
</script>

<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMinYMin meet" viewBox="0 0 255 145" 
    class="logo {signedIn}" width="100%" height="100%" >
    <defs>
        <ref id="paramColor" param="color" default="#ccc"/>
    </defs>
    <g transform="translate(2.018 1.396)">
        <path
